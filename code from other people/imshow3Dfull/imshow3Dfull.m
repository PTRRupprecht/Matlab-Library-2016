...
ImgAx = Img;
ImgSg = permute(Img, [3 1 2]);   % Sagittal view image
ImgSg = ImgSg(end:-1:1,:,:);   % Sagittal view image
ImgCr = permute(Img, [3 2 1]);   % Coronal view image
ImgCr = ImgCr(end:-1:1,:,:);   % Sagittal view image
