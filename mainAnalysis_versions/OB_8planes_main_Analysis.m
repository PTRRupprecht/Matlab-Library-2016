...
%% load list of files
FileList_0 = dir('Fish1_FullOB_*.tif');
FileList = FileList_0;
clear meta
...
for pp = 8 % which plane do you want to choose right now?
    counter_planes{pp} = 0;
...
save(strcat('Extracted_Data_fish1_19-05-16_FullOB.mat'),'plane');
